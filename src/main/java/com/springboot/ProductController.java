...
public class ProductController {
	...
	@GetMapping("/get/{id}")
	public ResponseEntity<Product> getDataById(@PathVariable("id") int product_id) {
	...
	@PutMapping("/get/{id}")
	public ResponseEntity<Product> updateDataById(@PathVariable("id") int product_id, @RequestBody Product c) {
		Optional<Product> lst = cr.findById(product_id);
		if (lst.isPresent()) {
	...
	public ResponseEntity<Product> deleteDataById(@PathVariable("id") int product_id) {
		Optional<Product> lst = cr.findById(product_id);
		if (lst.isPresent()) {
